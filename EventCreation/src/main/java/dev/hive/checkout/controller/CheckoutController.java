...
public class CheckoutController {
    ...
    public String addCheckoutData(@RequestBody Checkout checkout) {
        ...
        // Get rowid of ix purchase from rows table
            ...
            Map<String, Object> dynamicRow = jdbcTemplate.queryForMap(
                    ticketRowEventSql,
                    rowIdValue,
                    eventid
            );
            ...
            for (Map.Entry<String, Object> entry : dynamicRow.entrySet()) {
                System.out.println(entry.getKey() + " = " + entry.getValue());
            }

            //NEXT: update parkingbyevent & rowsbyevent by...
            // -> compare passes sold (parkingpass) to total passes allowed (parkingbyevent) with some math & update passes left
            // -> compare/subtract tix quantity from the correct row for the correct event
