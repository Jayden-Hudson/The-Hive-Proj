...
public class CheckoutController {
    ...
    public String addCheckoutData(@RequestBody Checkout checkout) {
        ...
        // use event id to update parkingpass table if order included a pass
        ...
        // Get rowid of ix purchase from rows table
            ...
            // Update tickets left atomically
            ...
            //END UPDATE rowsbyevent
            //ADD: logic to... 1. check if ticketsleft = 0, 2. set to soldout to true & reflect in ui

            //UPDATE parkingbyevent
            ...
            //END UPDATE parkingbyevent
            //ADD: logic to check if soldout (passessold = passesavailable, & if so...
            //1. set soldout to true, 2. dissallow anymore passes to be sold for that show/reflect in ui
